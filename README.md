...
- Acceptance ledger: 524/524 gates marked met in [GATES.md](GATES.md).
...
- `src/harness-factory.mjs` — lifecycle façade for research intake, architecture manufacture, archived-proposal replay, proposal-history archive, archive inspection, and candidate retirement
