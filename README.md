...
- Acceptance ledger: 536/536 gates marked met in [GATES.md](GATES.md).
...
- `src/harness-factory.mjs` — lifecycle façade for research intake, architecture manufacture, archived-proposal replay, replay research backlog and receipts, replay outcome accounting, proposal-conversion measurement, proposal-history archive, archive inspection, and candidate retirement
