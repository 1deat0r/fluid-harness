...
- Acceptance ledger: 520/520 gates marked met in [GATES.md](GATES.md).
...
- `src/harness-factory.mjs` — lifecycle façade for research intake, architecture manufacture, proposal-history archive, archive inspection, and candidate retirement
