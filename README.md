...
- Acceptance ledger: 550/550 gates marked met in [GATES.md](GATES.md).
...
- `src/harness-factory.mjs` — lifecycle façade for research intake, architecture manufacture, archived-proposal replay, fair bounded replay backlog and receipts, replay attempt/exhaustion accounting, replay outcome accounting, proposal-conversion measurement, proposal-history archive, archive inspection, and candidate retirement
